...
function Cart() {
    const { getCartContext, removeItemContext, deleteallCartContext, increaseContext, decreaseContext } = useContext(CartContext);
    ...
    const clrCart = async () => {
        const res = await deleteallCartContext();
        return res;
    }
    ...
    useEffect(() => {
        if (!isLoading && data && data.products) {
            let newTotal = data.products.reduce((acc, product) => {
                ...
                <div className="row">
                    <div className="cart-items">
                        <div className="products" id="products">
                            ...
                            {!isCartEmpty && (
                                <button onClick={() => clrCart()}>Clear Items</button>
                            )}
                        </div>
